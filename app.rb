...
class WordGuesserApp < Sinatra::Base
  ...
  post '/guess' do
    ...
    if @game.guesses.include? letter or @game.wrong_guesses.include? letter then
  ...
  get '/show' do
    ...
    redirect '/win' and return if state.equal? :win
    redirect '/lose' and return if state.equal? :lose
